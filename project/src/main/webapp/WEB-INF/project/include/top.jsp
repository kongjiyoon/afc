	...
	<div class="menu1" style="width: 100%;" align="left">
		<div class="col-sm-12">
			...
			<ul class="list-inline" id="list1">
				<li id="qual"><a href="/project/qualifiers.do"
					style="text-decoration: none;">QUALIFIERS</a></li>
				...
				<li id="tic"><a href="/project/ticketing/matchlist.do" style="text-decoration: none;">TICKETING</a></li>
			</ul>
			<hr>
		</div>
	</div>
